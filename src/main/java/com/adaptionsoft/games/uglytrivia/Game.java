...
public class Game {
	...
	private void getPopQA() {
		popQuestions.addAll(Arrays.asList("What is the smallest planet in our solar system?",
				"What sport did David Beckham play?", "What has Mohammed Ali’s original name?",
				"What does the Latin word 'tempus' mean in English?",
				"What is the smallest planet in our solar system?", "What sport did David Beckham play?",
				"What has Mohammed Ali’s original name?", "What does the Latin word 'tempus' mean in English?"));

		popAnswers.addAll(
				Arrays.asList("Mercury", "Football", "Boxing", "Time", "Mercury", "Football", "Boxing", "Time"));
	...
	private void getRockQA() {
		rockQuestions.addAll(Arrays.asList("Which is the largest country in the world?",
				...
				"In which country would you find the Leaning Tower of Pisa?", "Which planet is nearest to the Earth??",
				"Which is the largest country in the world?", "Which country has the largest population in the world?",
				"In which country would you find the Leaning Tower of Pisa?",
				"Which planet is nearest to the Earth??"));

		rockAnswers.addAll(Arrays.asList("Russia", "China", "Italy", "Venus", "Russia", "China", "Italy", "Venus"));
	...
	private void getSceinceQA() {
		scienceQuestions.addAll(Arrays.asList("Which animal lays eggs?", "A male cow is called?",
				"All animals need food, air, and ____ to survive.", "Which one is a fur-bearing animal?",
				"Which animal lays eggs?", "A male cow is called?", "All animals need food, air, and ____ to survive.",
				"Which one is a fur-bearing animal?"));

		scienceAnswers.addAll(Arrays.asList("Duck", "Ox", "Water", "Cat", "Duck", "Ox", "Water", "Cat"));
	...
	private void getSportsQA() {
		sportsQuestions.addAll(Arrays.asList("Which sport has 11 playes on the field?",
				...
				"What sport is described as “the beautiful game?”", "How long is the total distance of a marathon?",
				"Which sport has 11 playes on the field?", "Which sport uses a net, a racket, and a shuttlecock?",
				"What sport is described as “the beautiful game?”", "How long is the total distance of a marathon?"));

		sportsAnswers.addAll(Arrays.asList("Cricket", "Badminton", "Football", String.valueOf(5), "Cricket",
				"Badminton", "Football", String.valueOf(5)));
